(function () {
    ...
    $(document).ready(function () {
        registerUiTemplateListeners();
        registerDeleteLinkListener();
    });

    function registerDeleteLinkListener() {
        $(document.body).on('click', selectors.deleteLink, function () {
    ...
    function registerUiTemplateListeners() {
        /* ==========================================================================
         Scroll
         ========================================================================== */
        ...
        if ($('.select2').size()) {
            ...
            if ($('.select2-arrow').length) {
                $(".select2-arrow").not('.manual').select2({
                    theme: "arrow"
                });
            }

            if ($('.select2-no-search-arrow').length) {
            ...
            if ($('.select2-no-search-default').length) {
                $('.select2-no-search-default').select2({
                    minimumResultsForSearch: "Infinity"
                });
            }

            if ($('.select2-white').length) {
                $(".select2-white").not('.manual').select2({
                    theme: "white"
                });
            }

            if ($('.select2-photo').length) {
